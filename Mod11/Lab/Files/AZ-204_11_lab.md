---
lab:
    az204Title: 'Lab 11: Asynchronously processing messages by using Azure Queue Storage'
    az020Title: 'Lab 11: Asynchronously processing messages by using Azure Queue Storage'
    az204Module: 'Module 11: Develop message-based solutions'
    az020Module: 'Module 11: Develop message-based solutions'
    type: 'Answer Key'
---
...
1.  In the **Add Message** pop-up window, perform the following actions:
    ...
    1.  Ensure that the **Encode message body in UTF-8** check box isn't selected.
...
### [<-- Back to Lab 11](../11_EvidencesLab.md)
