...
namespace AdventureWorks.Web
{
    public class Startup
    {
        ...
        public void ConfigureProductService(IServiceCollection services)
        {
            ...
            //     provider => new AdventureWorksSqlContext(_configuration.GetConnectionString(nameof(AdventureWorksSqlContext)))
            // );

            services.AddScoped<IAdventureWorksProductContext, AdventureWorksCosmosContext>(
                provider => new AdventureWorksCosmosContext(_configuration.GetConnectionString(nameof(AdventureWorksCosmosContext)))
            );
        }
